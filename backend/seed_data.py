...
async def seed(drop_first: bool = False):
    ...
    async with AsyncSessionLocal() as session:
        ...
        role_perm_mappings = {
            ...
            "teacher": ["attendance:read:own_class", "attendance:write:own_class", "academics:write:own_class", "academics:read:own_school", "fees:read:own"],
            "mentor": ["attendance:read:own_class", "academics:read:own_school", "students:manage:own_school"],
            "finance_manager": ["payroll:manage:own_school", "payroll:read:own_school", "fees:manage:own_school", "fees:read:own_school"],
            "hostel_warden": ["hostel:manage:own_school", "hostel:read:own_school"],
            "transport_admin": ["transport:manage:own_school", "transport:read:own_school"],
            "librarian": ["library:manage:own_school", "library:read:own_school"],
            "student": ["fees:read:own", "attendance:read:own_class", "library:read:own_school"],
