      ...
      <div className="space-y-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs text-gray-600">• Official Timetable</span>
            </div>
        ...
        <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm p-6 rounded-2xl border border-gray-200 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-gray-600 font-mono">Grade 10-A • Student ID: PB-2024-089</span>
          </div>
            ...
            <table className="w-full text-left text-xs">
              <thead className="bg-gray-50/90 text-gray-600 uppercase text-[10px] font-semibold border-b border-gray-200">
                <tr>
                  ...
                  <th className="p-3.5 text-right font-bold text-brand-black">Max Marks</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {studentExams.map((e, idx) => (
                  <tr key={idx} className="hover:bg-gray-50/40 transition-colors">
                    ...
                    <td className="p-3.5 font-mono text-gray-600">{e.code}</td>
                    <td className="p-3.5 text-gray-700">{e.hall}</td>
                    <td className="p-3.5 font-mono font-bold text-amber-400">{e.seat}</td>
                    <td className="p-3.5 text-right font-mono font-bold text-emerald-600 text-sm">{e.max_marks}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        {/* Instructions Card */}
        <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm p-5 rounded-2xl border border-gray-200 space-y-2">
          <div className="text-xs font-bold uppercase text-gray-600 tracking-wider flex items-center gap-1.5">
          ...
          <ul className="text-xs text-gray-700 space-y-1.5 list-disc list-inside">
            ...
            <li>Carry your physical printed Hall Ticket and Genesis ERP student ID badge to all sessions.</li>
          </ul>
        </div>
            ...
            <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm border border-gray-200 max-w-lg w-full rounded-2xl p-6 space-y-4 shadow-2xl">
              <div className="flex items-center justify-between border-b border-gray-200 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-brand-black">Genesis ERP Certified Hall Ticket</h3>
                    <p className="text-[10px] text-gray-600">CBSE Affiliation No: 1930281 • Term 1 2026</p>
                  </div>
                </div>
                <button onClick={() => setShowHallTicketModal(false)} className="text-gray-600 hover:text-brand-black">
                  <X className="w-5 h-5" />
                </button>
              </div>

              <div className="p-4 rounded-xl bg-gray-950/60 border border-gray-200 space-y-2.5 text-xs">
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <span className="text-gray-500">Student Name:</span>
                    <div className="font-bold text-brand-black">{user?.full_name || "Kishor Kumar"}</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="text-brand-black">Grade 10 - Section A</div>
                  </div>
                  <div>
