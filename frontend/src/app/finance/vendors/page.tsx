    ...
    <ProtectedRoute allowedRoles={['super_admin', 'correspondent', 'admin', 'principal', 'finance']}>
      <div className="space-y-6 max-w-6xl mx-auto">
        <header className="mb-8 flex justify-between items-center">
          ...
          <button className="bg-amber-600 hover:bg-amber-700 text-brand-black px-4 py-2 rounded-xl flex items-center gap-2">
          ...
          <table className="w-full text-left text-sm text-gray-600">
            ...
            <tbody className="divide-y divide-gray-800">
              <tr className="hover:bg-gray-100/30 transition-colors">
                <td className="px-6 py-4 font-bold text-brand-black">Dell Technologies India</td>
              ...
              <tr className="hover:bg-gray-100/30 transition-colors">
                <td className="px-6 py-4 font-bold text-brand-black">Shree Stationery Mart</td>
