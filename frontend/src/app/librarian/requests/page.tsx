      ...
      <div className="space-y-6 max-w-7xl mx-auto">
        <header className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400 mt-2">Manage new book requests from teachers and forward budget requests to Finance.</p>
          </div>
        </header>
              ...
              <tbody className="divide-y divide-gray-800">
                <tr className="hover:bg-gray-800/30 transition-colors">
                  <td className="px-6 py-4">
                    <div className="font-bold text-white">Quantum Computing Since Democritus</div>
                    <div className="text-xs text-gray-500">Scott Aaronson</div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="font-bold text-gray-300">Sarah Connor</div>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex gap-2">
                      <button className="text-emerald-400 hover:text-emerald-300 p-1 bg-emerald-500/10 rounded-lg border border-emerald-500/20 transition-colors" title="Approve & Order">
                      ...
                      <button className="text-cyan-400 hover:text-cyan-300 p-1 bg-cyan-500/10 rounded-lg border border-cyan-500/20 transition-colors" title="Forward to Finance">
                ...
                <tr className="hover:bg-gray-800/30 transition-colors">
                  <td className="px-6 py-4">
                    <div className="font-bold text-white">A Brief History of Time</div>
                    <div className="text-xs text-gray-500">Stephen Hawking</div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="font-bold text-gray-300">Kishor K</div>
                  ...
                  <td className="px-6 py-4 text-center">
                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-cyan-500/10 text-cyan-400 border border-cyan-500/20">Sent to Finance</span>
                  </td>
                  <td className="px-6 py-4">
