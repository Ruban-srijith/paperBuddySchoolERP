...
export default function LoginPage() {
  ...
  const [selectedSchool] = useState<School>(PRIMARY_SCHOOL);
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F8F9FD] dark:bg-[#0b0f19] p-4 font-sans overflow-hidden transition-colors duration-300">
      {/* Background Animated Elements */}
          ...
          <motion.div 
            ...
            className="w-full max-w-lg bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-[36px] shadow-2xl overflow-hidden relative flex flex-col pt-10 pb-8 px-8 min-h-[580px] border border-gray-100 dark:border-slate-800 z-10 transition-colors duration-300"
          >
