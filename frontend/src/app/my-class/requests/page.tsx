    ...
    <ProtectedRoute allowedRoles={['teacher', 'super_admin', 'admin', 'principal']}>
      <div className="space-y-6 max-w-3xl mx-auto">
        <header className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Request funds for lab equipment, project materials, or class events.</p>
        </header>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-[24px] border border-gray-100 shadow-sm p-8 rounded-2xl border border-gray-200 space-y-6">
          <div>
            ...
            <input 
              ...
              className="w-full bg-gray-50/50 border border-gray-200 text-brand-black rounded-xl px-4 py-3 focus:outline-none focus:border-cyan-500" 
              required 
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-600 mb-2">Requested Amount (₹)</label>
            <input 
              type="number" 
              value={amount} 
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full bg-gray-50/50 border border-gray-200 text-brand-black rounded-xl px-4 py-3 h-32 focus:outline-none focus:border-cyan-500" 
              required 
            />
          </div>
          <button type="submit" className="w-full bg-cyan-600 hover:bg-cyan-700 text-brand-black font-bold py-4 rounded-xl flex justify-center items-center gap-2">
