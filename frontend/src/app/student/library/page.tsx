    ...
    <ProtectedRoute allowedRoles={['student', 'super_admin', 'admin']}>
      <div className="space-y-6 max-w-7xl mx-auto">
        <header className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Search the catalog, view your issued books, and access digital resources.</p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm p-5 rounded-2xl border border-gray-200">
            ...
            <div className="text-3xl font-bold text-brand-blue">14</div>
            ...
            <div className="space-y-4">
              <div className="bg-white border border-gray-200 rounded-xl p-4">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="font-bold text-brand-black">Advanced Physics Vol 2</h3>
                    <p className="text-sm text-gray-600">H.C. Verma</p>
                  </div>
                ...
                <div className="mt-4 pt-4 border-t border-gray-200 flex items-center gap-2 text-sm">
                  ...
                  <span className="text-gray-700">Due: <span className="text-brand-black font-medium">Oct 25, 2026</span></span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm p-6 rounded-2xl border border-gray-200">
            ...
            <div className="relative mb-6">
              ...
              <input 
                ...
                className="w-full bg-gray-50 border border-gray-200 text-brand-black rounded-xl pl-10 pr-4 py-2.5 focus:outline-none focus:border-sky-500"
              />
            </div>

            <div className="space-y-2">
              <h3 className="text-sm font-medium text-gray-600 mb-3 uppercase tracking-wider">Suggested for you</h3>
              <div className="flex items-center justify-between p-3 hover:bg-gray-100/50 rounded-lg cursor-pointer transition-colors border border-transparent hover:border-gray-200">
                <div className="flex items-center gap-3">
                  <BookOpen className="w-4 h-4 text-gray-600" />
                  <div>
                    <div className="text-sm font-medium text-brand-black">Calculus Early Transcendentals</div>
        ...
        <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm p-6 rounded-2xl border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-white border border-gray-200 rounded-xl p-4 hover:border-violet-500/50 cursor-pointer transition-colors">
              <h3 className="font-bold text-brand-black">Coursera: Python Basics</h3>
              <p className="text-sm text-gray-600 mt-1">Free access via campus license</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-xl p-4 hover:border-violet-500/50 cursor-pointer transition-colors">
              <h3 className="font-bold text-brand-black">JSTOR Archive Access</h3>
              <p className="text-sm text-gray-600 mt-1">Research papers and journals</p>
            </div>
          </div>
        </div>
      </div>
