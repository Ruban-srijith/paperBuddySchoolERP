    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-500 text-white text-sm font-medium shadow-lg shadow-cyan-500/25 hover:opacity-90 transition-all disabled:opacity-50"
        >
          <Zap className="w-4 h-4 text-amber-300" />
          {autoAssigning ? "Querying Free Teachers..." : "Auto-Assign Substitute"}
        </button>
      </div>
