      ...
      <div className="space-y-6 max-w-7xl mx-auto">
        <header className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400 mt-2">Request new books for your subjects and recommend readings for your students.</p>
          </div>
          <button className="bg-sky-600 hover:bg-sky-700 text-white px-4 py-2 rounded-xl flex items-center gap-2 transition-colors">
            ...
            <div className="space-y-4">
              <div className="bg-gray-900/60 border border-gray-800 rounded-xl p-4">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="font-bold text-white">Quantum Computing Since Democritus</h3>
                    <p className="text-sm text-gray-400">Scott Aaronson</p>
                  </div>
          ...
          <div className="glass-panel p-6 rounded-2xl border border-gray-800">
            ...
            <div className="relative mb-6">
              ...
              <input 
                ...
                className="w-full bg-gray-900 border border-gray-700 text-white rounded-xl pl-10 pr-4 py-2.5 focus:outline-none focus:border-emerald-500"
              />
            </div>
