    ...
    <div className="min-h-screen w-screen overflow-hidden flex flex-col relative bg-[#14251c] text-[#f4f0e6]">
      ...
      <div className="relative z-10 flex-1 flex flex-col h-screen max-w-[1720px] w-full mx-auto p-2 sm:p-4">
        <div className="flex-1 flex flex-col lg:flex-row brutal-concrete-chassis overflow-hidden relative">
          ...
          <aside className={`fixed lg:relative z-50 lg:z-10 w-[245px] h-full brutal-stone-sidebar p-3.5 flex flex-col justify-between overflow-hidden transform transition-transform duration-200 ease-out lg:translate-x-0 ${showMobileMenu ? 'translate-x-0' : '-translate-x-full'}`}>
            <div className="flex-1 flex flex-col space-y-2.5 overflow-hidden min-h-0">
              ...
              <div className="flex-none flex flex-col items-center justify-center pt-1 pb-2 border-b border-[#e5c158]/20 relative">
                <Link href="/" className="flex flex-col items-center text-center group">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-b from-[#243a2c] to-[#122218] border-2 border-[#e5c158]/50 flex items-center justify-center shadow-[0_8px_25px_rgba(0,0,0,0.6),inset_0_2px_4px_rgba(255,255,255,0.3)] mb-1.5 relative overflow-hidden group-hover:border-[#e5c158] transition-all">
